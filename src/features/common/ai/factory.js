...
const PROVIDERS = {
  ...
  'openai-orbit': {
      ...
      handler: () => require("./providers/openai"),
      llmModels: [
          { id: 'gpt-5-2025-08-07-orbit', name: 'GPT-5 (2025-08-07) (orbit)' },
          { id: 'gpt-5-mini-2025-08-07-orbit', name: 'GPT-5 Mini (2025-08-07) (orbit)' },
  ...
  'gemini': {
      ...
      llmModels: [
          ...
          { id: 'gemini-ultra-2.0', name: 'Gemini Ultra 2.0' },
          { id: 'gemini-1.5-pro-latest', name: 'Gemini 1.5 Pro Latest' },
          { id: 'gemini-2.5-flash', name: 'Gemini 2.5 Flash' },
      ],
      sttModels: [
          { id: 'gemini-live-2.0-flash', name: 'Gemini Live 2.0 Flash' },
  ...
  'deepgram': {
    ...
    llmModels: [],
    sttModels: [
        { id: 'deepgram-general', name: 'Deepgram General' },
