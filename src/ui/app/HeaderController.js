...
class HeaderTransitionManager {
    constructor() {
        ...
        if (window.api) {
            ...
            window.api.headerController.onForceShowApiKeyHeader(async () => {
                ...
                if (!isConfigured) {
                    // Skip welcome screen - go directly to main since API keys are centrally managed
                    this.transitionToMainHeader();
                } else {
    ...
    async _bootstrap() {
        ...
        if (window.api) {
            ...
            // Fallback for non-electron environment (testing/web) - skip welcome screen
    ...
    async handleStateUpdate(userState) {
        ...
        if (isConfigured) {
            ...
            // Skip welcome screen - directly transition to main header since API keys are centrally managed
            this.transitionToMainHeader();
        }
    }
